...
public class SiteMapGeneratorTest
{
    ...
    public void testGenerateSiteMap() throws Exception
    {
        ...
        List<SiteUrlLocation> locations = ListUtils.builder()
                                                   .add(new SiteUrlLocation("https://www.imbs-alliance.org/en-US", lastModified, 1.0, ListUtils.builder()
                                                                                                                                               .add(new AlternativeLocalizedUrlLocation("https://www.imbs-alliance.org/en-US",
                                                                                                                                                                                        Locale.US))
                                                                                                                                               .add(new AlternativeLocalizedUrlLocation("https://www.imbs-alliance.org/fr",
                                                                                                                                                                                        Locale.FRENCH))
                                                                                                                                               .build()))
                                                   .add(new SiteUrlLocation("https://www.imbs-alliance.org/fr", lastModified, 1.0, ListUtils.builder()
                                                                                                                                            .add(new AlternativeLocalizedUrlLocation("https://www.imbs-alliance.org/en-US",
                                                                                                                                                                                     Locale.US))
                                                                                                                                            .add(new AlternativeLocalizedUrlLocation("https://www.imbs-alliance.org/fr",
                                                                                                                                                                                     Locale.FRENCH))
